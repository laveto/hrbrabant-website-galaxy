...
?>
<footer class="<?php echo e($cssNs); ?>">

    <div class="relative">
        <img src="<?php echo e($footerImage); ?>" alt="Footer afbeelding" class="aspect-[3/1] sm:aspect-[auto] w-full object-cover" />
        ...
        <div class="container font-semibold navItems">
            <div class="grid gap-4 py-4 lg:grid-cols-12 lg:pt-12 lg:pb-24">
                <div class="col-span-5 mb-4 lg:mb-0">
                    <img src="<?php echo e($logo); ?>" alt="Logo <?php echo e(config('app.name')); ?>" />
                </div>

                <div class="col-span-2">
                    <div class="mb-2 font-medium text-white uppercase opacity-75">
                        <?php echo e($footerBlock->extra?->{'kolom_1_->_titel'}->value ?? ''); ?>
                ...
                <div class="flex flex-col col-span-2 text-white">
                    <div class="mb-2 font-medium text-white uppercase opacity-75">
                        <?php echo e($footerBlock->extra?->{'kolom_2_->_titel_1'}->value ?? ''); ?>

                    </div>

                    <?php echo $footerBlock->extra?->{'kolom_2_->_beschrijving'}->value ?? ''; ?>


                    <div class="pt-8 mb-2 text-white uppercase opacity-75">
                        <?php echo e($footerBlock->extra?->{'kolom_2_->_titel_2'}->value ?? ''); ?>

                    </div>

                    <?php echo $footerBlock->extra?->{'kolom_2_->_beschrijving_2'}->value ?? ''; ?>

                </div>

                <div class="flex flex-col col-span-2 font-medium text-white">
                    <div class="mb-2 font-medium text-white uppercase opacity-75">
                        <?php echo e($footerBlock->extra?->{'kolom_3_->_titel'}->value ?? ''); ?>

                    </div>

                    <?php echo $footerBlock->extra?->{'kolom_3_->_beschrijving'}->value ?? ''; ?>


                    <div class="pt-4 mt-auto mb-2 font-medium text-white uppercase opacity-75">
                        <?php echo e($footerBlock->extra?->{'kolom_4_->_titel'}->value ?? ''); ?>

                    </div>

                    <?php echo $footerBlock->extra?->{'kolom_4_->_beschrijving'}->value ?? ''; ?>
            ...
            <div class="flex flex-col gap-4 py-4 mt-4 border-t border-white border-opacity-25 lg:flex-row lg:items-center lg:py-8 lg:mt-0">
                ...
                <div class="flex flex-col gap-8 text-sm lg:pl-8 lg:ml-auto md:flex-row md:items-center">
                    <div class="text-white opacity-50 lg:text-center">
                        &copy; <?= date('Y') ?> <?php echo e(config('app.name')); ?>
...
<?php /**PATH /Users/kevin/Herd/hrbrabant-website-galaxy/resources/views/vendor/website/layouts/main/footer.blade.php ENDPATH**/ ?>